...
const OauthSettings: UserManagerSettings = {
  ...
  redirect_uri: process.env.ROOT_URL + 'auth/bnet/',
  silent_redirect_uri: process.env.ROOT_URL + 'auth/bnet/silent_refresh',
  post_logout_redirect_uri: process.env.ROOT_URL + 'auth/login',
  response_type: 'code',
